	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'container' },
	        _react2.default.createElement(_header2.default, { text: 'Open Source Saturday Proposals' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _issues = __webpack_require__(171);
	...
	var Table = function (_React$Component) {
	  ...
	  function Table() {
	    ...
	    _this.state = { issues: _this.issues() };
	    return _this;
	  }

	  _createClass(Table, [{
	    key: 'populateFromJSON',
	    value: function populateFromJSON() {
	      return [{ link: '', id: 2, number: 3, owner: 'Hulk Hogan', project: 'Scandal' }];
	    }
	  }, {
...
/***/ function(module, exports) {
	...
	var Issues = function () {
	  ...
	  _createClass(Issues, [{
	    key: 'data',
	    value: function data() {
	      return [{ link: 'https://github.com/Sketch-Chest/chest/issues/5' }, { link: 'https://github.com/JikkuJose/chest/issues/7' }, { link: 'https://github.com/Rajes/chest/issues/87' }, { link: 'https://github.com/Juil/chest/issues/70' }, { link: 'https://github.com/Nikhi/chest/issues/37' }];
	    }
	  }, {
	    key: 'enumerate',
	    value: function enumerate() {
	      var o = this.data().map(function (item, index) {
	        var words = item.link.replace('//', '').split('/');
